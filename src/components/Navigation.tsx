      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="text-xl sm:text-2xl font-serif font-bold text-gray-900">PielMorena</Link>
          </div>
          ...
          <div className="md:hidden flex items-center">
            <button
              ...
              className="text-gray-900 hover:text-[#3c3430] transition-colors duration-300 p-2"
